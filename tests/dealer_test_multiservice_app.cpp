...
void worker(dealer_t* d, std::vector<int>* dealer_messages_count, int dealer_index, const std::string& app_path)
{
	message_path_t path(app_path, "rimz_func");
